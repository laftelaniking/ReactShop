  ...
  return (
    <div className='App'>
      ...
      <Navbar bg="light" data-bs-theme="light">
        <Container>
          ...
          <Nav className="me-auto">
            <Nav.Link href="#home" onClick={()=>{ navigate(1) }}>Home</Nav.Link>
      ...
      <Routes>
        ...
        */}
        {/* <Route path='/about/member' element={ <div>회사멤버</div>} />
        <Route path='/about/location' element={ <div>회사위치</div>} /> */}

        <Route path='/about' element={ <div>회사멤버</div>} >
          <Route path='member' element={ <div>멤버</div> }/>
          <Route path='location' element={ <div>멤버</div> }/>
        </Route>
